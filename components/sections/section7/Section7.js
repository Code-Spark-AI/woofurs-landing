  ...
  const data = [
    {
      ...
      description: `Streamline operations with automated scheduling and client management.`,
    },
    {
      id: nanoid(),
      icon: <BallIcon colorFill={"#7AC143"} />,
      title: "Market Access",
      description: `Connect with pet parents in Bangalore's premium neighborhoods.`,
    },
    {
      id: nanoid(),
      icon: <AlarmClockIcon />,
      title: "Analytics Dashboard",
      description: `Track performance and make data-driven decisions for your business.`,
    },
    {
      id: nanoid(),
      icon: <BallIcon colorFill={"#7AC143"} />,
      title: "Flexible Commissions",
      description: `Fair commission structure with volume-based incentives.`,
    },
  ];
  ...
  return (
    ...
    >
      <Box w="full">
        ...
        <Flex direction="column" pt="30px" gridGap="30px">
          {data.map((e) => (
